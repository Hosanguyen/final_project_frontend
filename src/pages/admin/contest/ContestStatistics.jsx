  ...
  return (
    <div className="contest-statistics">
      ...
      <div className="stats-section practice-section">
        <h2><Code size={24} /> Practice Mode</h2>
      ...
      <div className="stats-section">
        <h2><Trophy size={24} /> Contest Mode</h2>
      ...
      {charts && (
        <div className="charts-section">
          <div className="chart-container">
            <h3><BarChart3 size={20} /> Xu hướng Contest (12 tháng)</h3>
                  ...
                  {charts.contests_by_month.map((item, index) => (
                    <div key={index} className="bar-item">
                      <div 
                        className="bar" 
                        style={{ 
                          height: `${Math.max((item.count / Math.max(...charts.contests_by_month.map(i => i.count))) * 100, 5)}%` 
                        }}
          ...
          <div className="chart-container">
            <h3><TrendingUp size={20} /> Tăng trưởng thí sinh (12 tháng)</h3>
            <div className="simple-chart">
                  ...
                  {charts.participants_growth.map((item, index) => (
                    <div key={index} className="bar-item">
                      <div 
                        ...
                        style={{ 
                          height: `${Math.max((item.count / Math.max(...charts.participants_growth.map(i => i.count))) * 100, 5)}%` 
                        }}
              ...
              <div key={index} className="submission-status-item">
                ...
                <div className="status-bar">
                  <div 
                    ...
                    style={{ 
                      width: `${(item.count / contests.submissions.total_submissions * 100).toFixed(1)}%` 
                    }}
                  />
                </div>
                <span className="status-count">
                  {item.count} ({((item.count / contests.submissions.total_submissions * 100).toFixed(1))}%)
                </span>
              </div>
            ))}
          </div>
      ...
      {contests.top_performers && contests.top_performers.length > 0 && (
        <div className="stats-section">
          <h2><Award size={24} /> Top Performers</h2>
                ...
                {contests.recent_contests.map((contest) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td>
                        <span className={`mode-badge mode-${contest.contest_mode.toLowerCase()}`}>
